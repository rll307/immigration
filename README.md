...
[Rodrigo Esteves de Lima-Lopes](mailto:rll307@unicamp.br)
...
The image Click on _select file_ and choose the texts. In this study I have chosen to use a file for each newspaper, so I could analyse them separately. 
...
After we processes the files, COWO we will use another software [Vosviewer](http://www.vosviewer.com) as a _passage_ to Gephi. 
...
Then apply the following size and colour configuration
- Size -> ranking -> degree and apply size 21 - 50 to the size of the nodes
- Colour -> Partition, modularity class. 
